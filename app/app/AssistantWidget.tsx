          ...
          {!isPremium ? (
            <div className="flex-1 flex flex-col items-center justify-center px-6 text-center">
              ...
              <p className="text-xs text-[#08090A]/75 leading-relaxed mb-5">
                Upgrade to <strong className="text-amber-500">Lifetime (₹1,499)</strong> or Pro to unlock the AI sales coach. Suggests niches, rewrites your pitch, plans your follow-ups.
              </p>
              <Link
                href="/pricing"
